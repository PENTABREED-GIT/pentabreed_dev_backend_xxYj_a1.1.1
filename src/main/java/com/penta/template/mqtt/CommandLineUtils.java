package com.penta.template.mqtt;
    ...
    private void parseCommonLoggingCommands(SampleCommandLineData returnData){
        ...
        if(verbosity != "None"){
            switch (log_destination) {
                case "Stderr":
                    Log.initLoggingToStderr(Log.LogLevel.valueOf(verbosity));
                    break;
                case "Stdout":
                    Log.initLoggingToStdout(Log.LogLevel.valueOf(verbosity));
                    break;
                case "File":
                    Log.initLoggingToFile(Log.LogLevel.valueOf(verbosity), log_file_name);
                    break;
                default:
                    break;
            }
